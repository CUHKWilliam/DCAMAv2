python -u -m torch.distributed.launch --nproc_per_node=4 --master_port=18021 \
./train.py --datapath "/research/d6/rshr/xjgao/twl/data" \
           ...
           --lr 1e-4 \
           --nepoch 50 \
           --load "/research/d6/rshr/xjgao/twl/logistic_project/DCAMA/checkpoint/coco-20i/swin_fold3.pt" \
           --nshot 2
